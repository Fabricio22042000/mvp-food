...
insert into restaurante (id, nome, taxa_frete, cozinha_id, endereco_cidade_id, endereco_cep, endereco_bairro, endereco_logradouro, endereco_numero, endereco_complemento, data_criacao, data_atualizacao) values (1, 'Thai Gourmet', 10, 1, 1, '58038521', 'Manaira', 'Rua Francisco Brandão', '1595', 'Ap 105', utc_timestamp, utc_timestamp);
